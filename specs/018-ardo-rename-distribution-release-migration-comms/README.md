...
Complete rename across package distribution channels and release workflows, and
publish migration communication assets for users upgrading from Coco to Ardo.
...
- [x] Define and implement deprecation or redirect behavior for legacy package
      names.
...
- [x] Legacy package/channel behavior (redirect/deprecation) is explicit and
      validated.
